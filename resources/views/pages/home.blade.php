        ...
        <section class="row">
            <section class="col-12">
                ...
                <div class="section-title text-center mb-4">
                    <h3 class="gallery-title">Foto Dan Video</h3>
                    <div class="line-separator mx-auto"></div>
                </div>
                ...
                <div class="text-center mt-4">
                    <a href="{{ route('galery.index') }}" class="text-primary">
                        <i class="bi bi-arrow-right-circle"></i> Lihat Galeri
                    </a>
                </div>
...
<div class="row mt-4"> <!-- Tambahkan mt-4 untuk memberikan margin atas -->
