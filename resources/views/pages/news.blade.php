            ...
            <div class="col-xl-8">
                ...
                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        @foreach ($newsRandom as $newsRandom )
                            ...
                            <div id="hotnews"
                                ...
                                <div>
                                    <a href="{{ '/news/'.$latesNews->id_title }}">
                                        <span>{{$latesNews->title}}</span>
                                    </a>
                                    <div>
                                        </p>{{$latesNews->updated_at->diffForHumans()}}
                                    </div>
                                </div>
                            </div>
                            @endforeach
                    ...
                    <div class="card-body">
                        ...
                        <div id="allnews" class="row p-3">
                            ...
                            <div class="col-sm-8 grid-margin pt-2 pt-md-0">
                                ...
                                <p class="mb-0">
                                    {!! Str::limit($newsRandom->content, 350) !!} <a href="{{ "/news/".$newsAll->id_title }}">Baca Selengkapnya</a>
                                </p>                                
                            </div>
                        </div>
                        @endforeach
