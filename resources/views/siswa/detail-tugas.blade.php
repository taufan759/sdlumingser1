        ...
        <div class="col-md-8">
            <div class="card shadow" style="border-radius: 15px;">
                <div class="card-header text-center" style="background-color: #007bff; color: white;">
                    <h3 class="card-title">Tugas Untuk {{ $siswa->nama }}</h3>
                </div>
                    ...
                    @isset($tugas)
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 text-center">
                                @if($tugas->foto)
                                    <div class="mb-3">
                                        <img src="{{ asset('storage/tugas/' . $tugas->foto) }}" alt="Foto Tugas" class="img-fluid" style="max-width: 100%; border-radius: 15px; cursor: pointer;" data-bs-toggle="modal" data-bs-target="#fotoModal">
                        ...
                        <hr>
                        <a href="{{ route('siswa.tugas') }}" class="btn btn-secondary mt-3">
                        ...
                        @else
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-between align-items-center" style="border-radius: 10px; margin-bottom: 10px; background-color: #e1f5fe;">
                                    ...
                                    <a href="{{ route('siswa.detail-tugas', $item->id) }}" class="btn btn-info btn-sm"><i class="fa-solid fa-eye"></i> Lihat Tugas</a>
                                </li>
                                @endforeach
                            </ul>
                        @endif
