        ...
        <table class="table-borderless table-striped table-hover mb-0 table align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">{{ $siswa->user->nama }}</td>
                    <td>
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left mr-3">
                                    <div class="widget-content-left">
                                        <img width="40" class="rounded-circle" src="{{asset('storage/'.$siswa->image)}}"
                                            alt="Profil Siswa">
                                    </div>
                                </div>
                            </div>
                    ...
                    <td class="text-center">
                        <div class="badge badge-success">{{ $siswa->user->NIS }}</div>
                    </td>
                    <td class="text-center">
                    ...
                    <td class="text-center">
                        <a href="/guru/siswa/view/{{ $siswa->id }}/={{ urlencode($siswa->nama_siswa) }}" id="PopoverCustomT-2"
